...
from main.registration_view import RegistrationView


class TestUrls(SimpleTestCase):
    def test_new_tags_url_is_resolved(self):
        url = reverse('main:new_tags', kwargs={'pk': 1})
        self.assertEqual(resolve(url).func, views.add_new_tags_view)

    def test_login_redirect_url_is_resolved(self):
        url = reverse('main:login_redirect')
        self.assertEqual(resolve(url).func, views.login_redirect_view)
    ...
    def test_feed_url_is_resolved(self):
        ...
        self.assertEqual(resolve(url).func.view_class, views.FeedView)

    def test_new_post_url_is_resolved(self):
        url = reverse('main:new_post')
        self.assertEqual(resolve(url).func, views.add_new_post_view)

    def test_profile_setting_url_is_resolved(self):
        url = reverse('main:profile_setting')
        self.assertEqual(resolve(url).func.view_class, views.ProfileSettingView)
    ...
    def test_follow_user_url_is_resolved(self):
        ...
        self.assertEqual(resolve(url).func, views.follow_user_view)
    ...
    def test_followers_following_url_is_resolved(self):
        ...
        self.assertEqual(resolve(url).func.view_class, views.FollowersFollowingView)

    def test_like_post_url_is_resolved(self):
        url = reverse('main:like_post', kwargs={'pk': 1})
        self.assertEqual(resolve(url).func, views.like_view)

    def test_bookmark_post_url_is_resolved(self):
        url = reverse('main:bookmark_post', kwargs={'pk': 1})
        self.assertEqual(resolve(url).func, views.bookmark_view)
